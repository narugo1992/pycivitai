...
from pycivitai.config.meta import __VERSION__


@pytest.fixture(scope='module')
def sample_cli():
    from pycivitai.utils import GLOBAL_CONTEXT_SETTINGS
    from pycivitai.utils import print_version as _origin_print_version
